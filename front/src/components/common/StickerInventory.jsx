  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 12 }}>
        <span style={{ fontSize: 12, color: '#666', alignSelf: 'center' }}>카테고리:</span>
        <button 
          onClick={() => setCategoryFilter('all')} 
          style={{ 
            padding: '6px 10px', 
            border: '1px solid #dee2e6', 
            backgroundColor: (categoryFilter === 'all') ? '#343a40' : '#f8f9fa', 
        ...
        <button 
          ...
          style={{ 
            padding: '6px 10px', 
            border: '1px solid #dee2e6', 
            backgroundColor: (categoryFilter === 'champion') ? '#0d6efd' : '#f8f9fa', 
            color: (categoryFilter === 'champion') ? '#fff' : '#333', 
            borderRadius: 4, 
            cursor: 'pointer', 
            fontSize: 12 
          }}
        ...
        <button 
          ...
          style={{ 
            padding: '6px 10px', 
            border: '1px solid #dee2e6', 
            backgroundColor: (categoryFilter === 'item') ? '#20c997' : '#f8f9fa', 
            color: (categoryFilter === 'item') ? '#fff' : '#333', 
            borderRadius: 4, 
            cursor: 'pointer', 
            fontSize: 12 
          }}
        ...
        <button 
          ...
          style={{ 
            padding: '6px 10px', 
            border: '1px solid #dee2e6', 
            backgroundColor: (categoryFilter === 'rune') ? '#6f42c1' : '#f8f9fa', 
            color: (categoryFilter === 'rune') ? '#fff' : '#333', 
            borderRadius: 4, 
            cursor: 'pointer', 
            fontSize: 12 
          }}
        ...
        <button 
          ...
          style={{ 
            padding: '6px 10px', 
            border: '1px solid #dee2e6', 
            backgroundColor: (categoryFilter === 'emote') ? '#fd7e14' : '#f8f9fa', 
            color: (categoryFilter === 'emote') ? '#fff' : '#333', 
            borderRadius: 4, 
            cursor: 'pointer', 
            fontSize: 12 
          }}
